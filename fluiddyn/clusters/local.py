...
class ClusterLocal(Cluster):
    ...
    def __init__(self):
        ...
        if virtualenv is not None:
            self.commands_setting_env.append('source ' + virtualenv + '/bin/activate')
    ...
    def submit_command(
            ...
            nb_cores_per_node=None, walltime='23:59:58', nb_mpi_processes=None,
            retain_script=True, omp_num_threads=1, ask=True, bash=True,
