    ...
    def test_submit_non_default(self):
        ...
        with stdout_redirected():
            self.cluster.submit_script(
                self._script, name_run='test', nb_nodes=2,
                nb_cores_per_node=nb_cores_per_node, walltime='2-23:59:58',
                nb_mpi_processes=1, retain_script=False, omp_num_threads=2,
                ask=False, bash=False, interactive=True)
